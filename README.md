...
# WARNING:
- If any of your modules automatically deletes the chat archive other than you clicking on the flush chat log button (i.e. DF Chat Enhancements Archive function), **DISABLE** Message Deletions via config first! Otherwise, your discord messages will be deleted! This will be fixed in 1.8.0, hang tight!
